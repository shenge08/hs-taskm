...
public class PluginContainerController {
    ...
    @Parameter(name = "pluginInstanceId", description = "插件 ID", required = true, example = "1")
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
    ...
    public Result<String> stopContainer(@PathVariable Long pluginInstanceId) {
        pluginContainerManager.stopPluginContainer(pluginInstanceId);
    ...
    public Result<String> restartContainer(@PathVariable Long pluginInstanceId) {
        pluginContainerManager.restartPluginContainer(pluginInstanceId);
    ...
    public Result<Map<String, String>> getContainerStatus(@PathVariable Long pluginInstanceId) {
        String status = pluginContainerManager.getContainerStatus(pluginInstanceId);
